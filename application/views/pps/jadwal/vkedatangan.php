...
<html>
<head>
<title>KEDATANGAN KAPAL - PELABUHAN PERIKANAN SAMUDERA KENDARI</title>
...
<body onload="javascript:setTimeout('location.reload(true);',60000);">
	...
	<div class="marquee">SELAMAT DATANG DI PELABUHAN PERIKANAN SAMUDERA KENDARI</div>
        <div id="header">		
			...
			&nbsp;<div id="kiri"><b>KEDATANGAN KAPAL</b></div><div id="kanan"><b><div id='clock'></div></b></div>
        </div>		
		<div id="line"></div>
        <div id="content">
