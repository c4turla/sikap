...
<div class="page-subheading page-subheading-md">
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="javascript:;">Edit Es</a></li>
    </ol>
</div>
...
<div class="container-fluid-md">
	<div class="panel panel-primary">
        ...
        <div class="panel-body">
			<?php echo form_open_multipart("data/simpanes",'class="form-horizontal form-bordered FormProfile"'); ?>
            ...
            <legend class="form-legend">
                ...
                <div class="form-group">
					...
					<div class="col-sm-4">
						<input type="number" class="form-control" id="nominal" placeholder="Jumlah Es" name="nominal"  value="<?php echo $nominal ?>">
					</div>
				</div>
