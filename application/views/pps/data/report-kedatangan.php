...
<div class="page-subheading page-subheading-md bg-white">
  <?php echo form_open('report/ExportKedatangan', "class='filter-form-data'"); ?>
    <div class="row">
        ...
        <div class="col-sm-2 col-xs-5">
          <button type="button" name="preview" class="btn btn-primary search-filter">Preview</button>
        </div>
...
<div class="container-fluid-md">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h4 class="panel-title"><strong>PREVIEW REPORT DATA KEDATANGAN</strong></h4>
