...
<div class="page-subheading page-subheading-md">
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="javascript:;">Tambah BBM</a></li>
    </ol>
</div>
...
<div class="container-fluid-md">
	<div class="panel panel-primary">
        ...
        <div class="panel-body">
			<?php echo form_open_multipart("data/TambahBBM",'class="form-horizontal form-bordered FormProfile",data-toggle="validator"','data-toggle="validator"'); ?>
            <fieldset>
                ...
                <div class="form-group">
					...
					<div class="col-sm-4">
                        <input type="number" class="form-control" id="nominal" placeholder="Jumlah BBM" name="nominal" required>
                        <input type="hidden" id="nama_kategori" name="nama_kategori" value="BBM">
					</div>
				</div>
            ...
            <fieldset>
				<div class="form-group">
					<div class="col-sm-offset-3 col-sm-9">
                        ...
                        <a href="<?php echo base_url(); ?>data/bbm" class="btn btn-warning"><i class="fa fa-times"></i> Cancel</a>
					</div>
				</div>
